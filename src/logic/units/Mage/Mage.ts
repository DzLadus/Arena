...
import MageTargetBehaviour from '../TargetsBehaviours/MageTargetBehaviour';
...
export default class Mage extends Unit{
    ...
    constructor(healthPoint: number, initiative: number, damageCapacity: number, logo: any, name: string, boardPos: number){
        super(healthPoint, initiative, MAGE, logo, name, boardPos);
        this._damageCapacity = damageCapacity;
        this._damageBehaviour = new DamagerBehaviour();
        this._targetBehaviour = new MageTargetBehaviour();
    }   
